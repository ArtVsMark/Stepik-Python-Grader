...
### Added
- Метаданные пакета: `[project.urls]` (Homepage/Repository/Changelog/Issues), `authors` и `classifiers` — со страницы пакета на PyPI есть путь в репозиторий, changelog и issue-трекер, а связь «дистрибутив ↔ репозиторий» выражена в METADATA, а не только в README (#765)
