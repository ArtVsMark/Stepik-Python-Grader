...
function setMode(m) {
  ...
  // issue #683: «Отправить в Stepik» — только режим 1; сброс в disabled до
  // грейда. Кнопка живёт внутри #file-picker-group (скрывается вместе с ним),
  // поэтому свой hidden ей больше не нужен: в шапке её появление сдвигало
  // переключатель режимов при каждом переключении.
