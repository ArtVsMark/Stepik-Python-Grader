...
| DEV-1-02 | --sandbox без --mode молча игнорируется | #1062 |
| LNCH-2-01 | То же: меню запускает решения без изоляции | #1062 |
| SBX-4-03 | --sandbox без --mode: в меню OK, под --mode 1 FAIL | #1062 |
| SEC-2-01 | --sandbox без --mode: меню грейдит через LocalRunner | #1062 |
| LNCH-2-03 | --serve игнорирует record_history из pyproject и тумблер | #1062 |
| LNCH-3-01 | --serve игнорирует персистентный опт-аут истории | #1062 |
| LNCH-5-01 | Сохранённый выбор «история ВЫКЛ» игнорируется при --serve | #1062 |
| SET-2-03 | --serve не читает персистентный тумблер истории | #1062 |
| LNCH-3-02 | Один флаг record_history — три несогласованные лестницы | #1062 |
| FZZ-5-04 | _resolve_record_history не читает .grader_settings.json | #1062 |
