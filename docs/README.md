...
| **(архив)** Разовые аудиты 2026-07 (глубокие 8-ролевые 2026-07/07-14/07-15 + `role-*.md`-приложения + полный issue-аудит всех 253 issue) — вынесены в подкаталог с собственным индексом (issue #562) | [archive/README.md](archive/README.md) |
