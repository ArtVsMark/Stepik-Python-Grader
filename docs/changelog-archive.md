# Changelog Archive — до-версионные записи

> Архив записей `CHANGELOG.md`, сделанных **до** появления git-тегов/
> `setuptools-scm`-версионирования (issue #162/#183) — все датированы июнем
> 2026 и оформлены как `## [unreleased] / <дата>`/`## [Unreleased] — <месяц>`,
> а не как настоящие релизы `## [X.Y.0] - ДАТА`. Вынесены сюда issue #267,
> чтобы `CHANGELOG.md` не разрастался бесконечно вниз старыми
> псевдо-Unreleased снимками. Живая часть (актуальный `[Unreleased]` +
> версионированные релизы `[1.1.0]`...) остаётся в
> [`../CHANGELOG.md`](../CHANGELOG.md).
>
> Тот же период пересказан по-русски, сводно, на уровне спринтов/issue — в
> [history.md](history.md). Здесь — построчный английский лог по PR, как в
> живой части `CHANGELOG.md`; там — курируемая русская сводка. Разные
> уровни детализации одного периода, не рассинхронизированный дубль.
