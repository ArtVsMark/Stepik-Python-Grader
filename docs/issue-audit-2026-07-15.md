...
> **Статус: АРХИВ (обновлено 2026-07-18).** Разовый снимок на #1–#390; хвосты
> (эпик #413 → #411/#412) закрыты, число открытых устарело. Не активный план —
> читать как историю; актуальные статусы — в GitHub Issues.
>
