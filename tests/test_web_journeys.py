...
already cover most journeys from `docs/dev/web-current.md § User journeys` in
...
# download_task() returned (docs/dev/web-current.md J0: "путь скачанной папки
...
# case must resolve to a real card, not a dead link (docs/dev/web-current.md J3
