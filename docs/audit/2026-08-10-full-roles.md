...
| DEV-1-03 | Ctrl+C в интерактивном меню роняет процесс трейсбеком | #1060 |
| PROD-1-03 | То же: KeyboardInterrupt вместо штатного выхода | #1060 |
| DEV-1-05 | Диалог tkinter открывается в неинтерактивном запуске | #1060 |
| INS-5-06 | Справка не отвечает на вопрос «откуда взять задачу» | #1060 |
| JRN-1-04 | Раскладку tests/ узнаёшь только провалившись | #1060 |
| VIS-1-06 | «тали вердиктов» — непереведённая калька в справке и документации | #1060 |
