...
| [facts-export.md](facts-export.md) | Факты проекта для соседних репозиториев: числа тестов, версии матрицы и эталонный набор проверок PR — веткой `badges`, чтобы сосед не клонировал нас ради двух подсчётов |
...
| [corpus.md](corpus.md) | Прогонный корпус: сверка вердиктов ядра на задачах целиком, каталог мутаций, порядок разбора расхождения, границы стенда |
| [performance.md](performance.md) | Базовые замеры стоимости самого грейдера: старт CLI, загрузка комплектных данных, цена тест-кейса, параллельные прогоны; как повторить |
