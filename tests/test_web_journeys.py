...
already cover most journeys from `docs/dev/web-contracts.md § User journeys` in
...
# download_task() returned (docs/dev/web-contracts.md J0: "путь скачанной папки
...
# case must resolve to a real card, not a dead link (docs/dev/web-contracts.md J3
