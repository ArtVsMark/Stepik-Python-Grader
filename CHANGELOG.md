...
### Added
- Глоссарий: поле `version` («доступно с Python X.Y») проставлено 108 карточкам по маркеру «Added in version» из docs.python.org — `match/case` 3.10, `StrEnum` 3.11, `itertools.batched` 3.12, `statistics.kde` 3.13; формат приведён к канону `X.Y` (#684)
