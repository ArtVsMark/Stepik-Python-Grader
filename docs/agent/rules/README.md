...
|---|---|---|
| [Транспорт к GitHub: REST по умолчанию, GraphQL только там, где REST не умеет](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/001-transport-rest-not-graphql.md) | #1233, #1265 | не объявлено |
| [Правило без механизма — обещание, а не гарантия](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/002-rule-without-mechanism.md) | #1296, #1329 | не объявлено |
| [Имя ветки может быть переключателем поведения, а не соглашением о стиле](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/003-branch-name-is-a-switch.md) | #1302, #1320 | не объявлено |
| [Конфликт — штатная ситуация конвейера, а не авария](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/004-conflict-is-normal-not-outage.md) | #1313 | не объявлено |
...
| [Окно, зависшее на разрешении, снаружи неотличимо от работающего](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/007-blocked-window-looks-alive.md) | #1321, #1323 | не объявлено |
| [Пустой список проверок означает «не стартовало», а не «всё хорошо»](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/010-empty-checklist-is-not-green.md) | #1232 | не объявлено |
...
| [Свои артефакты держат вне маски входа](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/119-tool-artefacts-stay-outside-the-input-mask.md) | `tests/conftest.py` | не объявлено |
| [Каталог правил ведётся по своим правилам, а указатель к нему генерируется](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/120-how-to-run-a-rule-catalogue.md) | #1342 | не объявлено |
