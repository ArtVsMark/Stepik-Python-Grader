...
|---|---|
| Находок всего | **898** |
| Отклонено верификаторами | 12 REFUTED + 16 DUPLICATE = 28 |
| В работу | **870** — 16 high · 161 medium · 693 low (шкала верификаторов, см. § 4) |
| Подтверждено полностью (CONFIRMED) | 558 |
| Подтверждено частично (PARTIAL) | 313 |
| Дефектов текущего поведения (`bug`) | 321 |
| Быстрых целей (`quick`) | 657 |
| Среднесрочных (`mid`) | 146 |
| Долгосрочных (`long`) | 7 |
| Срезов | 146 ролевых, зонных, прогонных, документных и ревизионных |
| Верификаций | 899 (100% находок, ни одной без вердикта) |
| Severity скорректирован верификатором | 487 находок |
| Волн Workflow | 31, ровно по 5 агентов (две последние — добор из 1-2); потеряно 3 агента, все добраны |
