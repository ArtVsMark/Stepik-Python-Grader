...
решение принять и почему). Код — с типизацией и docstring; язык ответов —
русский по умолчанию. Разбор конкретного файла — до ответа от ролей.
