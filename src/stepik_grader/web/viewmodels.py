...
# «Модель error cards»).
# issue #1517: OLE — тоже провал кейса, и карточка ошибки ему нужна: без
# неё студент видит вердикт без объяснения, почему проверка не состоялась.
_FAILURE_VERDICTS = frozenset({"WA", "RE", "TLE", "OLE"})
