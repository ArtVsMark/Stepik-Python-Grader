...
----------------------------------------------------------------------------------------------------------------------
task.py                                         10/10        0.4231        0.0423           48.03          OK          -
task_1.py                                       10/10        0.3870        0.0387           48.04          OK          -
task_2.py                                        8/10        0.3521        0.0352           48.02      FAILED          9
```
...
Это новый режим для **более объективного сравнения производительности**.
...
----------------------------------------------------------------------------------------------------------------------------------------------------------
task.py                                         70      0.03120     0.03410     0.03440     0.03790     0.00120       48.03      100.0%     SIMILAR
task_1.py                                       70      0.03110     0.03400     0.03420     0.03810     0.00130       48.04      100.0%     SIMILAR
task_2.py                                       70      0.03150     0.03680     0.03710     0.04140     0.00160       48.02      108.2%      SLOWER
```
