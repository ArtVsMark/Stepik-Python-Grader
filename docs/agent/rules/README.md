...
|---|---|---|
| **гейт** | падает в CI или в `preflight.py` | 62 |
| **шаг процесса** | проверяется человеком в названный момент | 36 |
| **не объявлено** | ответа проекта ещё нет — очередь на автоматизацию | 0 |
...
| [Агентское окно живёт три–пять дней](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/006-window-lifetime.md) | #1283 | шаг процесса |
...
| [Наблюдение: событие вместо опроса, а если опрос — то условный](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/011-events-not-polling.md) | `docs/agent/preflight.md` | шаг процесса |
...
| [«Тест краснеет до фикса» доказывается полу-откатом, а не откатом всего](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/014-red-before-fix-needs-partial-revert.md) | `docs/agent/preflight.md` | шаг процесса |
| [Агенты возвращают данные — файлы правит хост](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/015-agents-return-data-host-writes-files.md) | `docs/agent/multiagent.md` | шаг процесса |
...
| [Одно окружение проверяет узлы, другое — цепочку](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/018-cloud-checks-nodes-local-checks-chain.md) | `docs/agent/environments.md` | шаг процесса |
| [Аудит планируется от поверхностей продукта, а не от файлов](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/019-audit-from-surfaces-not-files.md) | `docs/agent/multiagent.md` | шаг процесса |
| [После сбоя перезапускать дельту, а не всю волну](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/020-restart-only-the-delta.md) | `docs/agent/multiagent.md` | шаг процесса |
...
| [Параллельные исполнители запускаются волнами фиксированного размера](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/031-waves-not-salvos.md) | `docs/agent/multiagent.md` | шаг процесса |
| [Если предмет роли наблюдаем в работающем продукте — роль обязана его запустить](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/032-role-must-run-the-product.md) | `docs/agent/roles.md` | шаг процесса |
| [Темп длинной работы считается от лимита, а не от желания](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/033-pace-from-limit-not-desire.md) | `docs/agent/multiagent.md` | шаг процесса |
| [Зона одного исполнителя должна быть маленькой](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/034-small-zone-per-executor.md) | `docs/agent/multiagent.md` | шаг процесса |
| [Дорогое окружение входит в аудит дважды и коротко](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/036-expensive-window-enters-twice-and-briefly.md) | `docs/agent/environments.md` | шаг процесса |
| [Находка, полученная не на той поверхности, — гипотеза](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/037-finding-status-depends-on-window.md) | `docs/agent/environments.md` | шаг процесса |
...
| [Смена правил работы — повод перезапустить окна, а не рассылка](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/047-rule-change-restarts-the-windows.md) | #1283 | шаг процесса |
...
| [Сбор и разбор — разные проходы](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/054-collect-and-analyse-are-separate-passes.md) | `docs/agent/course-walkthrough.md` | шаг процесса |
| [Собственный эталон — тоже гипотеза](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/055-your-own-expectations-are-a-hypothesis.md) | `docs/agent/course-walkthrough.md` | шаг процесса |
...
| [У каждого исчерпаемого ресурса есть заранее составленная карта обхода](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/059-map-the-detour-before-the-resource-runs-out.md) | `docs/agent/preflight.md` | шаг процесса |
| [Разбор после каждой волны, и качество важнее механики](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/060-debrief-every-wave-quality-first.md) | `docs/agent/multiagent.md` | шаг процесса |
| [Запреты окружения пишутся в задании, а не подразумеваются](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/061-environment-bans-belong-in-the-task.md) | `docs/agent/multiagent.md` | шаг процесса |
| [Роль заводится, если способна возразить, а не дополнить](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/062-a-role-must-be-able-to-object.md) | `docs/agent/roles.md` | шаг процесса |
| [Автоматическое вмешательство включается по всем условиям сразу](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/063-automatic-intervention-needs-all-conditions.md) | `docs/agent/dispatcher.md` | гейт |
| [Метки — вход механизма, а не украшение](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/064-labels-are-machine-input-not-decoration.md) | #1329 | гейт |
...
| [Намеренный дубль подписывается](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/071-deliberate-duplication-is-signed.md) | #433, `src/stepik_grader/web/auth_adapter.py`, `src/stepik_grader/launcher.py` | шаг процесса |
...
| [Состав ролей покрывает все пласты продукта, а не только разработку](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/082-roles-must-cover-every-layer.md) | #1005, #1007, `docs/agent/roles.md` | шаг процесса |
...
| [Тяжесть находки ставит не тот, кто её нашёл — но опровергателю нужна шкала](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/086-the-finder-does-not-grade-the-finding.md) | `docs/agent/multiagent.md` | шаг процесса |
| [Повторный проход получает на вход прошлые находки и запрет их переоткрывать](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/087-a-second-pass-needs-a-novelty-rule.md) | `docs/agent/multiagent.md` | шаг процесса |
| [Критик проверяет метод фазы, а не предмет работы](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/088-the-critic-checks-the-method-not-the-subject.md) | `docs/agent/multiagent.md` | шаг процесса |
...
| [Источники работы упорядочены: первый непустой и есть план](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/091-work-sources-are-ordered-first-non-empty-wins.md) | #97, #151 | шаг процесса |
| [Находки и порядок разбора — разные документы](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/092-findings-and-ordering-live-in-different-documents.md) | `docs/agent/claude-handoff.md` | шаг процесса |
...
| [Единица дробления определяется употреблением, а не формальным признаком](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/098-the-unit-of-splitting-follows-usage.md) | `docs/dev/glossary.md` | шаг процесса |
| [Конфликт классификации разрешается по последствию, а не по правильности](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/099-classification-conflicts-resolve-by-consequence.md) | `docs/dev/glossary.md` | шаг процесса |
...
| [У событийной автоматики должна быть ручная кнопка](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/104-event-driven-automation-needs-a-manual-button.md) | #988, #1095, `.github/workflows/ci.yml` | гейт |
...
| [Если инструмент может сделать сам — он делает, а не советует](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/111-do-it-instead-of-advising-it.md) | #1134, `src/stepik_grader/launcher.py` | шаг процесса |
...
| [Изменение везут одной темой: сборное честно, но неразбираемо](https://github.com/ArtVsMark/claude-code-playbook/blob/main/rules/ru/132-one-change-carries-one-topic.md) | #1350 | гейт |
