...
- **Связанный код/доки:** [core/runner.py](../../src/stepik_grader/core/runner.py),
  ...
  (`run_single_test`/`set_runner`), [docs/server-mode.md § Runner-слой](../server-mode.md),
  [docs/result-contract.md](../result-contract.md); развивает [ADR-0001](0001-server-mode.md)
...
3. **Runner не выносит verdict/diff.** Классификация AC/WA/TLE/RE и сравнение
   ...
   ([server-mode.md § Runner-слой](../server-mode.md)). Runner — только «запустить
