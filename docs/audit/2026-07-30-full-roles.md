...
**Закрыто:** `DESW-04` — PR #859 (плейсхолдеры обоих редакторов, stdin, пути и заголовка обратной связи переведены; подсказка contenteditable получила собственный ключ-компаньон).
