...
#342, дизайн — [audit-2026-07.md § 9](archive/audit-2026-07.md)). Здесь — форматы
...
> **Статус `lint_violations` (#403, замкнуто).** Контур наполнения замкнут:
...
(lint-нарушение, наполняется при `--lint --history` / web-грейдинге, #403).
