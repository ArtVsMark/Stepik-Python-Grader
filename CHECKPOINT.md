...
- Полный diff — [`CHANGELOG.md § [Unreleased]`](CHANGELOG.md).
...
- **#190 / #191** — follow-up доводка глоссария (валидация `kind/status`,
  снижение false-positive детектора).
- **#161** (эпик) ⊃ **#163** — UX вывода `--version` (dev vs release).
