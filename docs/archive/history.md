...
| v1.10.0 | 2295 | 94.8% (кросс-OS combined) | Канал обратной связи (эпик #751), глоссарий по официальному Python (stdlib 908/909, машинный аудит примеров), периметр безопасности (fuzz, escape-PoC, лимит вывода), подготовка к серверу (сериализуемый `RunSpec`, `HistoryRepository`), docs по четырём направлениям с пятью гейтами |
