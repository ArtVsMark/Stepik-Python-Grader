...
| MTX-10-04 | --output json печатает русский текст вместо JSON на ошибках | #1065 |
| RUN-4-04 | «Файлы решений не найдены в: {path}» — плейсхолдер печатается буквально | #1065 |
| SBX-1-04 | То же в прогоне под --sandbox | #1065 |
| DES-2-03 | _rows_to_markdown не экранирует «\|» и переводы строк | #1065 |
